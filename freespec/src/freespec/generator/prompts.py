...
class PromptBuilder:
    ...
    def build_compile_prompt(
        ...
        prompt_parts = [
            ...
            "",
            f"**YOU MUST READ `{impl_path}` BEFORE DOING ANYTHING ELSE.**",
            "",
            "The header file is the ONLY source of truth for:",
            "- Class names and their fields",
            "- Function signatures and parameters",
            "- Type hints",
            "- Method names",
            "",
            "**NEVER GUESS** what fields a class has or what parameters a function takes.",
            "**ALWAYS READ** the header file to see the exact structure.",
            "",
            "## Task",
            "",
            "You are implementing an EXISTING header/stub file. The header already defines:",
            ...
            "",
            "Your job is to:",
            "1. **READ the header file first** - do not skip this step",
            ...
            "",
            "## CRITICAL CONSTRAINTS - PRESERVE THE HEADER EXACTLY",
            "",
            ...
            "- DO NOT guess what fields exist - READ the header",
            ...
            "If you add a field that wasn't in the header -> VIOLATION",
            "",
    ...
    def build_compile_instructions_prompt(self, language: str) -> str:
        ...
        prompt_parts = [
            ...
            "",
            "## CRITICAL: Read Header Files First",
            "",
            "**NEVER GUESS what fields a class has or what parameters a function takes.**",
            "**ALWAYS READ the header/stub file first to see the exact structure.**",
            "",
            "The header file is the ONLY source of truth for:",
            "- Class names and their fields",
            "- Function signatures and parameters",
            ...
            "",
            "1. **READ the header/stub file first** - this is REQUIRED",
            "2. Note exact class fields, function signatures, and types",
            "3. READ the spec file to understand the behavior",
            "4. READ any @mentioned dependencies if needed",
            "5. Replace NotImplementedError() with working implementations",
            "6. Write tests that verify the spec's test cases",
            f"7. Run tests with {lang_info['test_command']} and iterate until all pass",
            "",
            "## Constraints",
            "",
            "- Do NOT add new public exports (classes, functions, constants)",
            "- Do NOT modify function signatures or type hints",
            "- Do NOT guess fields - READ the header to see what exists",
